...
1. Install the [required softwares](#dependencies) that will not be installed by `dotbot`:
        ...
        $ sudo apt-get install aspell-en aspell-fr autojump fish git-flow gnupg2 highlight pcscd pcsc-tools python-dev python-pip rxvt-unicode-256color scdaemon tig tmux vim
