...
set "cygPkgList=aspell,corkscrew,curl,dos2unix,fish,git,git-svn,highlight,keychain,python3,python3-pip,recode,the_silver_searcher,tig,tmux,tree,unzip,vim,wget"
