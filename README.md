...
1. Install the [required softwares](#dependencies) that will not be installed by `dotbot`:
        ...
        $ sudo apt install aspell-en aspell-fr autojump fish git-flow gnupg2 highlight libxml2-utils pcscd pcsc-tools python-dev python-pip rxvt-unicode-256color scdaemon shellcheck silversearcher-ag tig tmux vim
